...
class InventoryControllerTest {
    ...
    @Test
    void GET_returns_inventory() throws Exception {
    ...
    @Test
    void GET_returns_single_book() throws Exception {
    ...
    @Test
    void GET_returns_NOT_FOUND_for_non_existing_book() throws Exception {
